...
- (void)viewDidLoad {
    ...
    // UISwitch style
    NYSegmentedControl *roundedGreenSegmentedControl = [[NYSegmentedControl alloc] initWithItems:@[@"开", @"关"]];// FIXME: Suta
    ...
    roundedGreenSegmentedControl.titleFont = [UIFont fontWithName:@"AvenirNext-Medium" size:16.0f];    roundedGreenSegmentedControl.titleTextColor = [UIColor colorWithWhite:0.3f alpha:1.0f];
    roundedGreenSegmentedControl.selectedTitleFont = [UIFont fontWithName:@"AvenirNext-DemiBold" size:16.0f];    roundedGreenSegmentedControl.selectedTitleTextColor = [UIColor colorWithWhite:0.2f alpha:1.0f];
